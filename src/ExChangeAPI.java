...
public class ExChangeAPI {
    ...
    private static String url_API ="https://v6.exchangerate-api.com/v6/15ac1eea388da1e91d01c1ca/latest/";
    ...
    public double getEachRate(String newCurreny) {
        double eachRate = 0.0;
        try {
            eachRate = this.eachRate.getDouble(newCurreny);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return eachRate;
